...
const Hero = () => {
    ...
    return (
        <div id="hero" className='relative overflow-hidden flex justify-center px-30'>
            <Image
                src="/images/noise.png"
                alt=""
                height={2000}
                width={2000}
                className="absolute w-5/6 h-full object-cover init-0 opacity-100 mix-blend-screen mask-fade-circle"
            />
            <div className="absolute w-5/6 h-5/6 glow-circle pointer-events-none mix-blend-screen init-0" />
